...
<head>
  ...
  <link href="{{ public_asset('/assets/frontend/css/styles_disposable_v1.css') }}" rel="stylesheet"/>
  ...
  <div id="page-container">
    <!-- Navbar -->
      <nav class="navbar navbar-expand-md navbar-dark bg-navbar">
        <a class="navbar-brand float-right p-0 m-0" href="{{ url('/') }}"><img class="img-h40" src="{{ public_asset('/assets/img/logo_blue_bg.svg') }}"/></a>
    ...
    <div id="top_anchor" class="clearfix" style="height: 20px;"></div>
