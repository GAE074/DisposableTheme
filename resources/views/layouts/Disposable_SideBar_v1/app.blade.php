...
<html lang="en">
  <head>
    ...
    <link href="{{ public_asset('/assets/frontend/css/styles_disposable_sidebar_v1.css') }}" rel="stylesheet"/>
      ...
      <!-- Sidebar -->
        <div id="sidebar-wrapper" class="navbar-dark bg-sidebar">
          <div class="sidebar-heading">
            <a class="navbar-brand float-left p-0 mb-2" href="{{ url('/') }}"><img class="img-h40" src="{{ public_asset('/assets/img/logo_blue_bg.svg') }}"/></a>
          </div>
      ...
      <div id="page-content-wrapper">
        <div id="page-container">
          ...
          <div class="bg-transparent text-right ml-2 mr-2 mt-0 pt-1" style="font-weight: 500;">
            <i id="menu-toggle" class="fas fa-angle-double-left text-dark float-left" title="Toggle SideBar"></i>
            <span id="clock"></span> UTC<i class="fas fa-clock ml-1 mr-2"></i>
          </div> 
          <!-- End Top Navbar -->
          
          <div id="top_anchor" class="clearfix" style="height: 10px;"></div>
                ...
                <div class="col">
                  <div class="card mt-1 mb-1">
                    <div class="card-body p-1 text-center">
                      ...
                      <span><b>Disposable SideBar v1.01</b> by <a href="https://github.com/FatihKoz" target="_blank">B.Fatih KOZ</a></span>
